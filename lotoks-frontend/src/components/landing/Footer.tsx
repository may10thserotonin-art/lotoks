        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/60 text-sm">
              <li><a href="mailto:info@lotoks.co.za" className="hover:text-gold transition-colors">info@lotoks.co.za</a></li>
              <li><a href="tel:+27110518583" className="hover:text-gold transition-colors">Tel: +27 11 051 8583</a></li>
              <li><a href="tel:+27815069081" className="hover:text-gold transition-colors">Cell: +27 81 506 9081</a></li>
            </ul>
          </div>
        </div>
